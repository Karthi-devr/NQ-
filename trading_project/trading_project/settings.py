...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-nw2h)(r#77-@#7suhaw#5ii-j5fs2t2gbhqt11eo$3kpzgk)c7')
...
# WhiteNoise: serve compressed static files (no manifest hash required)
